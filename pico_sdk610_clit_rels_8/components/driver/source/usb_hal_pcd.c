...
void hal_remote_wakeup(usb_hal_pcd_t *hpcd)
{
    ...
    // gpio_pull_set(P17, GPIO_FLOATING);
    // gpio_dir(P18, GPIO_INPUT);
    // gpio_dir(P17, GPIO_INPUT);
    gpio_write(P5, 1);
    gpio_write(P4, 0);
    WaitMs(10);

    gpio_pull_set(P5, GPIO_FLOATING);
    gpio_pull_set(P4, GPIO_FLOATING);
    gpio_dir(P5, GPIO_INPUT);
    gpio_dir(P4, GPIO_INPUT);
#elif(0)
