...
**************************************************************************************************/
#ifndef __MCU_PICO_M0__
#define __MCU_PICO_M0__
...
typedef struct{
	...
	__IO uint32_t	 adc_intr_clr;		//0x80
	__IO uint32_t	 adc_intr_mask;		//0x84
	__IO uint32_t	 adc_intr_src;		//0x88
	__IO uint32_t	 adc_sync_data_out; //0x8C
	__IO uint32_t	 reserved[61]; //
	__IO uint32_t	 change_state;		//0x184
	__IO uint32_t	 i_clkhf_ctrl2;		//0x188
	__IO uint32_t	 i_clkhf_ctrl3;		//0x18C
	__IO uint32_t	 ANA_CTL1;			//0x190
