...
#else
// System ID characteristic
const uint8 devInfoPnpIdProps = GATT_PROP_READ;
const uint8 devInfoPnpId[DEVINFO_PNP_ID_LEN] =
{
  2,                                      // Vendor ID source (1=Bluetooth SIG)
  LO_UINT16(0x0504), HI_UINT16(0x0504),   // Vendor ID (Phyplus)
  LO_UINT16(0x0000), HI_UINT16(0x0000),   // Product ID (vendor-specific)
...
#else
const gattAttribute_t devInfoAttrTbl[] =
{
	// Device Information Service
	{
		{ ATT_BT_UUID_SIZE, primaryServiceUUID }, /* type */
...
bStatus_t DevInfo_AddService( void )
{
  ...
  return GATTServApp_RegisterService( (gattAttribute_t *)devInfoAttrTbl,
