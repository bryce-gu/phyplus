...
gattHandleReq_t serverReqTbl[] = {
  { NULL,                        NULL                          },//{ ATT_ParseExchangeMTUReq,     gattProcessExchangeMTUReq     }, /* ATT_EXCHANGE_MTU_REQ */
  ...
  { ATT_ParseReadBlobReq,        gattProcessReadReq			   },//{ ATT_ParseReadBlobReq,        gattProcessReadReq            }, /* ATT_READ_BLOB_REQ */
  { NULL,                        NULL                          },//{ ATT_ParseReadMultiReq,       gattProcessReadMultiReq       }, /* ATT_READ_MULTI_REQ */
  ...
  { NULL,                        NULL                          }, /* Undefined */
  { NULL,                        NULL                          },//{ ATT_ParsePrepareWriteReq,    gattProcessWriteReq           }, /* ATT_PREPARE_WRITE_REQ */
  { NULL,                        NULL                          },//{ ATT_ParseExecuteWriteReq,    gattProcessExecuteWriteReq    }  /* ATT_EXECUTE_WRITE_REQ */
};
#else
const gattHandleReq_t serverReqTbl[] = {
  { NULL,                        NULL                          },//{ ATT_ParseExchangeMTUReq,     gattProcessExchangeMTUReq     }, /* ATT_EXCHANGE_MTU_REQ */
  { ATT_ParseFindInfoReq,        gattProcessFindInfoReq        }, /* ATT_FIND_INFO_REQ */
  { ATT_ParseFindByTypeValueReq, gattProcessFindByTypeValueReq }, /* ATT_FIND_BY_TYPE_VALUE_REQ */
  { ATT_ParseReadByTypeReq,      gattProcessReadByTypeReq      }, /* ATT_READ_BY_TYPE_REQ */
