...
#else
// Battery level characteristic
const uint8 battLevelProps = GATT_PROP_READ | GATT_PROP_NOTIFY;
#endif
...
#else
const gattAttribute_t battAttrTbl[] =
{
  // Battery Service
  {
    { ATT_BT_UUID_SIZE, primaryServiceUUID }, /* type */
...
bStatus_t Batt_AddService( void )
{
  ...
  return GATTServApp_RegisterService( (gattAttribute_t *)battAttrTbl,
