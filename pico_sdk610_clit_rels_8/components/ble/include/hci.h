 ...
 *                                Unit: 0.625ms. Value Range: 0x0020-0x4000 (Time Range: 20ms-10.24s)
 * @param       advIntervalMax  - Maximum allowed advertising interval.
 *                                Unit: 0.625ms. Value Range: advIntervalMax-0x4000 (Time Range: advIntervalMax Time-10.24s)
 * @param       advType         - 0x00: HCI_CONNECTABLE_UNDIRECTED_ADV,
 *                                0x01: HCI_CONNECTABLE_DIRECTED_HDC_ADV,
 *                                0x02: HCI_SCANNABLE_UNDIRECTED,
 *                                0x03: HCI_NONCONNECTABLE_UNDIRECTED_ADV
 *                                0x04: HCI_CONNECTABLE_DIRECTED_LDC_ADV
 * @param       ownAddrType     - 0x00: HCI_PUBLIC_DEVICE_ADDRESS,
 *                                0x01: HCI_RANDOM_DEVICE_ADDRESS
 * @param       directAddrType  - 0x00: HCI_PUBLIC_DEVICE_ADDRESS,
 *                                0x01: HCI_RANDOM_DEVICE_ADDRESS
 * @param       directAddr      - Pointer to address of device when using
 *                                directed advertising.
 * @param       advChannelMap   - 0x01: HCI_ADV_CHAN_37,
 *                                0x02: HCI_ADV_CHAN_38,
 *                                0x04: HCI_ADV_CHAN_39,
 *                                0x03: HCI_ADV_CHAN_37 | HCI_ADV_CHAN_38,
 *                                0x05: HCI_ADV_CHAN_37 | HCI_ADV_CHAN_39,
 *                                0x06: HCI_ADV_CHAN_38 | HCI_ADV_CHAN_39,
 *                                0x07: HCI_ADV_CHAN_ALL
 * @param       advFilterPolicy - 0x00: HCI_ADV_WL_POLICY_ANY_REQ,
 *                                0x01: HCI_ADV_WL_POLICY_WL_SCAN_REQ,
 *                                0x02: HCI_ADV_WL_POLICY_WL_CONNECT_REQ,
 *                                0x03: HCI_ADV_WL_POLICY_WL_ALL_REQ
 *
 * output parameters
 *
 * @param       None.
 ...
 * input parameters
 *
 * @param       advEnable - 0x01: HCI_ENABLE_ADV 
 *                          0x00: HCI_DISABLE_ADV
 *
 * output parameters
 *
 * @param       None.
 ...
 *                             Unit: 0.625ms. Value Range: 0x0004-0x4000 (Time Range: 2.5ms-10.24s)
 * @param       scanWindow   - Time of scan before scan event ends.
 *                             Unit: 0.625ms. Value Range: 0x0004-scanInterval (Time Range: 2.5ms-scanInterval Time)
 ...
 *                             0x03: Random (static) Identity Addres
 * @param       filterPolicy - Filter policy with whitelist or not.
 *                             0x00: Whitelist invalid, filter by Peer_Address_Type & Peer_Address.
 *                             0x01: Filter by whitelist.
 *
 * output parameters
 *
 * @param       None.
 ...
 * input parameters
 *
 * @param       scanEnable       - 0x01: HCI_SCAN_START
 *                                 0x00: HCI_SCAN_STOP
 * @param       filterDuplicates - 0x01: HCI_FILTER_REPORTS_ENABLE,
 *                                 0x00: HCI_FILTER_REPORTS_DISABLE
 *
 * output parameters
 *
 * @param       None.
 ...
 *                                  Note: When the scanWindow equals the scanInterval
 *                                        then scanning is continuous.
 * @param       initFilterPolicy  - Filter policy with whitelist or not.
 *                                  0x00: Whitelist invalid, filter by Peer_Address_Type & Peer_Address.
 *                                  0x01: Filter by whitelist.
 * @param       addrTypePeer      - Type of target address.
 *                                  0x00: Public Device Address
 *                                  0x01: Random Device Address
 *                                  0x02: Public Identity Address
 *                                  0x03: Random (static) Identity Address
 * @param       peerAddr          - Pointer to address of target device
 * @param       ownAddrType       - Type of own address.
 *                                  0x00: Public Device Address
 *                                  0x01: Random Device Address
 *                                  0x02: Public Identity Address
 *                                  0x03: Random (static) Identity Addres
 * @param       connIntervalMin   - Minimum allowed connection interval.
 *                                  Unit: 1.25ms. Value Range: 0x0006-0x0C80 (Time Range: 7.5ms-4s)
 * @param       connIntervalMax   - Maximum allowed connection interval.
 *                                  Unit: 1.25ms. Value Range: connIntervalMin-0x0C80 (Time Range: connIntervalMin Time-4s)
 * @param       connLatency       - Number of skipped events (slave latency).
 *                                  Range: 0x0000-0x01F3
 * @param       connTimeout       - Connection supervision timeout.
 *                                  Unit: 10ms. Value Range: 0x000A-0x0C80 (Time Range: 100ms-32s)
 * @param       minLen            - Info parameter about min length of conn.
 *                                  Unit: 0.625ms. Value Range: 0x0000-0xFFFF (Time Range: 0-40.96s)
 * @param       maxLen            - Info parameter about max length of conn.
 *                                  Unit: 0.625ms. Value Range: minLen-0xFFFF (Time Range: minLen Time-40.96s)
 * output parameters
 *
 * @param       None.
 *
